...
function rfSignup(){ postNav(API + '/api/join-form', { email: (document.getElementById('su_email')||{}).value||'', password: (document.getElementById('su_pass')||{}).value||'', 'g-recaptcha-response': capResp() }); }
function rfLogin(){ postNav(API + '/api/login-form', { email: (document.getElementById('li_email')||{}).value||'', password: (document.getElementById('li_pass')||{}).value||'', 'g-recaptcha-response': capResp() }); }
